...
![struktur-folder-deploy-cp](../img/phase-3/struktur-folder-deploy-cp.png)
...
kafka_connect:
  ...
  vars:
    kafka_connect_custom_properties:
      plugin.path: /usr/share/java/kafka,/usr/share/java/confluent-security
...
![verifikasi-file-hosts-untuk-zookeeper](../img/phase-3/verifikasi-file-hosts-untuk-zookeeper.png)
...
```
![cek-syntax-playbook](../img/phase-3/cek-syntax-playbook.png)
...
```
![tes-konektivitas-ssh-ke-semua-node](../img/phase-3/tes-konektivitas-ssh-ke-semua-node.png)
...
```
![verifikasi-sudah-bisa-sudo](../img/phase-3/verifikasi-sudah-bisa-sudo.png)
...
![verifikasi-varible-efektif](../img/phase-3/verifikasi-varible-efektif.png)
...
![periksa-disk-semua-node](../img/phase-3/periksa-disk-semua-node.png)

## 5f. buat file ansible.cfg

buat di folder ~/confluent-ansible
...
> karena keterbatasan resource di lokal maka service yang di running adalaha, zookeeper, kafka-broker, kafka-connect dan c3 saja

**zookeeper:**

![vmlokal-zookeeper-run-node-1](../img/phase-3/vmlokal-zookeeper-run-node-1.png)

**kafka broker:**

![vmlokal-broker-run-node-1](../img/phase-3/vmlokal-broker-run-node-1.png)

**kafka connect:**

![vmlokal-kafka-connect-run-node-1](../img/phase-3/vmlokal-kafka-connect-run-node-1.png)

**c3:**
![running-c3-with-ansible](../img/phase-3/running-c3-with-ansible.png)
