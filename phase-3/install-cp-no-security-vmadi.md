...
![vmadi-graph-install-cp-hots-yml](../img/vmadi-graph-install-cp-hots-yml.png)
...
ksql_custom_properties:
  ...
  ksql.schema.registry.url: "http://confluent-4:8081"
...
kafka_rest_custom_properties:
  ...
  schema.registry.url: "http://confluent-4:8081"
...
```
![vmadi-tes-konektifitas-dari-file-hosts-yml](../img/phase-3/vmadi-tes-konektifitas-dari-file-hosts-yml.png)
...
```
![vmadi-tes-sudo-di-semua-server](../img/phase-3/vmadi-tes-sudo-di-semua-server.png)
...
## install java di node rhel server adi

jalankan disemua node rhel adi
```bash
wget https://download.java.net/java/GA/jdk17/latest/binaries/openjdk-17_linux-x64_bin.tar.gz
